-- Drop and recreate inventory_price_reports_view with all fields needed for mobile sync
...
FROM (
    SELECT id, product_code, product_name, image_url, product_type, est_price, updated_at,
           COALESCE(seller_sku1, seller_sku2, seller_sku3, seller_sku4) as seller_sku
    FROM product_base
) pb
